...
export const OverLayContentContext = createContext({overLayContent: '', updateOverLayContent: (value: string) => {value}});
...
function App() {
    ...
    return (
        <WindowSizeContext.Provider value={windowSize}>
            <OverLayContentContext.Provider value={{overLayContent, updateOverLayContent}}>
